define(["ratchet/web"], function (__WEBPACK_EXTERNAL_MODULE_ratchet_web__) {
...
/* harmony import */ var _module_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module.json */ "./src/module.json");
        ...
        function loadEnvScript() {
          ...
          if (!(currentProject && (currentProject.getId() === "adc1b8c41f72fd5edc33" || currentProject.getId() === "670e5a2f23cd025c3d45") && currentBranch)) {
            return;
          }
